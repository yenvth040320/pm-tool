  ...
  <div>
    <a-card class="mb-4">
      ...
      >
        ...
        >
          ...
          >
            <a-form-model-item
              :label="$t('module.versionApi.project_id')"
              prop="project_id"
            >
              <a-select
          ...
          >
            <a-form-model-item
              :label="$t('module.versionApi.api_id')"
              prop="api_id"
            >
              <a-select
          ...
          >
            ...
            >
              <a-input
                ...
                :placeholder="$t('module.versionApi.version_code')"
              >
                <font-awesome-icon
                  slot="prefix"
                  icon="heading"
          ...
          >
            <a-form-model-item
              :label="$t('module.versionApi.lock_flg')"
              prop="lock_flg"
            >
              <a-input
                v-model="filters.lock_flg"
                :placeholder="$t('module.versionApi.lock_flg')"
              >
                <font-awesome-icon
                  slot="prefix"
                  icon="heading"
    ...
    >
      <template slot="title">
        ...
        {{ currentId ? $t('common.edit') : $t('common.create') }} {{ $t('module.versionApi') }}
      </template>
...
import VersionApiForm from '~/components/templates/versionApi/VersionApiForm'
...
export default {
  ...
  computed: {
    header() {
      return [
        {
          title: this.$t('module.versionApi.project_id'),
          dataIndex: 'project_id',
          scopedSlots: { customRender: 'project_id' },
          sorter: true
        },
        {
          title: this.$t('module.versionApi.api_id'),
          dataIndex: 'api_id',
        ...
        {
          title: this.$t('module.versionApi.name_jp'),
          dataIndex: 'name_jp',
          sorter: true
        },
        {
          title: this.$t('module.versionApi.description'),
          dataIndex: 'description',
          sorter: true
        },
        {
          title: this.$t('module.versionApi.description_jp'),
