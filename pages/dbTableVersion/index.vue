  ...
  <div>
    <a-card class="mb-4">
      ...
      >
        ...
        >
          ...
          >
            <a-form-model-item
              :label="$t('module.dbTableVersion.project_id')"
              prop="project_id"
            >
              <a-select
          ...
          >
            <a-form-model-item
              :label="$t('module.dbTableVersion.db_table_id')"
              prop="db_table_id"
            >
              <a-select
          ...
          >
            ...
            >
              <a-input
                ...
                :placeholder="$t('module.dbTableVersion.version_code')"
              >
                <font-awesome-icon
                  slot="prefix"
                  icon="heading"
          ...
          >
            <a-form-model-item
              :label="$t('module.dbTableVersion.lock_flg')"
              prop="lock_flg"
            >
              <a-input
                v-model="filters.lock_flg"
                :placeholder="$t('module.dbTableVersion.lock_flg')"
              >
                <font-awesome-icon
                  slot="prefix"
                  icon="heading"
    ...
    >
      <template slot="title">
        ...
        {{ currentId ? $t('common.edit') : $t('common.create') }} {{ $t('module.dbTableVersion') }}
      </template>
...
export default {
  ...
  data() {
    return {
      ...
      filters: {
        ...
        lock_flg: this.$route.query.lock_flg || ''
      },
      defaultParams: {
        not_admin: 1
      },
  ...
  computed: {
    header() {
      return [
        {
          title: this.$t('module.dbTableVersion.project_id'),
          dataIndex: 'project_id',
          scopedSlots: { customRender: 'project_id' },
          sorter: true
        },
        {
          title: this.$t('module.dbTableVersion.db_table_id'),
          dataIndex: 'db_table_id',
          scopedSlots: { customRender: 'db_table_id' },
          sorter: true
        },
        {
          title: this.$t('module.dbTableVersion.version_code'),
          dataIndex: 'version_code',
          sorter: true
        },
        {
          title: this.$t('module.dbTableVersion.name'),
          dataIndex: 'name',
          sorter: true
        },
        {
          title: this.$t('module.dbTableVersion.name_jp'),
          dataIndex: 'name_jp',
          sorter: true
        },
        {
          title: this.$t('module.dbTableVersion.description'),
          dataIndex: 'description',
          sorter: true
        },
        {
          title: this.$t('module.dbTableVersion.description_jp'),
          dataIndex: 'description_jp',
          sorter: true
        },
        {
          title: this.$t('module.dbTableVersion.lock_flg'),
          dataIndex: 'lock_flg',
          sorter: true
        },
        {
