  ...
  <div>
    ...
    >
      <template slot="title">
        ...
        {{ currentId ? $t('common.edit') : $t('common.create') }} {{ $t('module.groupMember') }}
      </template>
...
import GroupMemberForm from '~/components/templates/groupMember/GroupMemberForm'
  ...
  data() {
    return {
      ...
      filters: {
        ...
        flg_add_point: this.$route.query.flg_add_point || '',
    ...
    header() {
      return [
        ...
        },
        {
          ...
          dataIndex: 'leader_id',
          scopedSlots: { customRender: 'leader_id' },
          sorter: true
        },
        {
