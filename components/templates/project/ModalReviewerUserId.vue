        ...
        <div class="p-4">
          ...
          >
            <a-row>
              ...
              >
                <a-form-model-item
                  :label="$t('module.tab_process.reviewer_user_id')"
                  prop="reviewer_user_id"
                >
                  <a-select
                    v-model="model.version_function_life_cycles.find(item => item.mst_life_cycle_id === mstLifeCycleId).reviewer_user_id"
                    mode="single"
                    :disabled="loading"
