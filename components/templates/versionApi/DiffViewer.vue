<template>
  <div>
    <div v-if="delta !== undefined">
      ...
      <div id="annotated" ref="annotated" :class="displayMode === 1 ? 'hide' : 'show'" v-html="annotatedContent" />
      <div id="visual" ref="visual" :class="displayMode === 2 ? 'hide' : 'show'" v-html="visualContent" />
    </div>
  ...
  methods: {
    updateDiffContent() {
      ...
      if (visualEl && annotatedEl) {
        ...
        const annotatedContent = jsonDiffFormatters.annotated.format(delta, left)
